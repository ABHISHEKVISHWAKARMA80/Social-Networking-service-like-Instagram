...
import com.example.instagram.SettingsActivity;
...
import com.example.instagram.adapter.ImageArrayAdapter;
...
//code for our profile, if we click on profile, we see my stuff
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        user = SharedPrefrenceManager.getInstance(getContext()).getUserData();
        user_id = user.getId();
