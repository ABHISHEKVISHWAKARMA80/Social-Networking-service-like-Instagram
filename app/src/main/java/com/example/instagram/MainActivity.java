...
import com.example.instagram.authentication.LoginActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user = SharedPrefrenceManager.getInstance(this).getUserData();
    ...
    private void logUserOutIFTheyWant(){
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                SharedPrefrenceManager sharedPrefrenceManger =
    ...
    protected void onStart() {
        ...
        boolean isUserLoggedIn =
                SharedPrefrenceManager.getInstance(getApplicationContext()).isUserLogggedIn();
