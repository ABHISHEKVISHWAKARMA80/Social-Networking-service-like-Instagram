...
import com.example.instagram.adapter.CommentListAdapter;
...
public class CommentsActivity extends AppCompatActivity {
    ...
    private void sendCommentToDB(final int story_id){
        ...
        User user = SharedPrefrenceManager.getInstance(this).getUserData();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLS.send_comment,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                commentData.put("user_id",String.valueOf(user_id));//can't pass Integer, so
