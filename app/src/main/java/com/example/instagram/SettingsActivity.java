                ...
                try {
                    ...
                    if(!jsonObject.getBoolean("error")){
                        ...
                        if(!emailString.isEmpty()) {
                            ...
                            SharedPrefrenceManager.getInstance(getApplicationContext()).updateEmail(emailString);
                        }
                    ...
                    try {
                        ...
                        if(!jsonObject.getBoolean("error")){
                            ...
                            if(!imageString.isEmpty()) {
                                ...
                                SharedPrefrenceManager.getInstance(getApplicationContext()).updateProfileImage(imageString);
